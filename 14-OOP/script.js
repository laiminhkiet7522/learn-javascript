...
const kiet = new Person('Kiet', 2002);
console.log(kiet);
...
console.log(kiet instanceof Person);
...
console.log(Person.prototype.isPrototypeOf(kiet));
console.log(Person.prototype.isPrototypeOf(Person));

Person.prototype.species = 'Homo Sapiens';
console.log(jonas.species, kiet.species);
...
class StudentCl extends PersonCl {
  ...
  calcAge() {
    console.log(
      `I'm ${
        2037 - this.birthYear
      } years old, bus as a student I feel more like ${
