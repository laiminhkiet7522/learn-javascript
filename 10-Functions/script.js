...
const checkIn = function (flightNum, passenger) {
  ...
  if (passenger.passport === 79202022037) {
    alert('Checked in!');
  }
  else {
...
lufthansa.book(7522, 'Minh Kiet');
lufthansa.book(9090, 'Jonas Schmedtmann');
...
// Call method
book.call(eurowings, 23, 'Sarah Willam');
...
book.call(swiss, 564, 'Harry Poter');
console.log(swiss);

// Apply method
const flightData = [564, 'John Cena'];
